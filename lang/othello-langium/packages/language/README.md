...
- [src/othello-dsl.langium](src/othello-dsl.langium) -  The grammar definition of your language
- [src/othello-dsl-module.ts](src/othello-dsl-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/othello-dsl-validator.ts](src/othello-dsl-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/othello-dsl.monarch.ts](src/syntaxes/othello-dsl.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/othello-dsl.tmLanguage.json](syntaxes/othello-dsl.tmLanguage.json) - Textmate based syntax highlighting instructions.
