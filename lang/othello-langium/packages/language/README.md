...
- [src/othello.langium](src/othello.langium) -  The grammar definition of your language
- [src/othello-module.ts](src/othello-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/othello-validator.ts](src/othello-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/othello.monarch.ts](src/syntaxes/othello.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/othello.tmLanguage.json](syntaxes/othello.tmLanguage.json) - Textmate based syntax highlighting instructions.
